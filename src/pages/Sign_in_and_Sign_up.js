import styles from './css_folder/Sign_in_and_Sign_up.module.css';
import { Link, useNavigate } from 'react-router-dom';
import { useRef, useState } from 'react';

function Sign_in_and_Sign_up() {
      ...
      <div className={`${styles['form-box']} ${styles.register}`}>
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className={styles['input-box']}>
            ...
            <input ref={inputRef} type="text" id='phone' name="phone" placeholder="010-xxxx-xxxx" value={isPhoneNum} onChange={handlePhoneNum} onKeyDown={(e)=> {handlePhoneKeyDown(e); handleKeyDownBlockNonNumeric(e);}} maxLength={13} required />
          </div>
          <div className={styles['input-box']}>
